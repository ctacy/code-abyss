const I18N = {
  en: {
    ...
    'graph.desc': 'v4.6 adds the <code>abyss</code> CLI — a Rust-powered code relationship graph that builds in <b>5 seconds</b>. Call graph, impact analysis, hotspot detection, change coupling. <b>Zero cloud dependencies.</b>',
  ...
  zh: {
    ...
    'graph.desc': 'v4.6 新增 <code>abyss</code> CLI —— 一个 Rust 驱动的代码关系图引擎，<b>5 秒</b>构建。调用图、影响面分析、热点检测、变更耦合。<b>零云端依赖。</b>',

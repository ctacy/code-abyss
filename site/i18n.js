const I18N = {
  en: {
    ...
    'site.desc': 'Composable persona + style + 22 engineering skills with 4 native security domains. For Claude Code, Codex, Gemini CLI & OpenClaw.',
    'nav.how': 'How',
    'nav.security': 'Security',
    'nav.personas': 'Personas',
    'nav.spec': 'Spec',
    'nav.install': 'Install',
    'hero.badge': '4.0 — Native Security Suite · Apache-free',
    'hero.title.1': 'Give your AI agent',
    'hero.title.2': 'a personality.',
    'hero.sub': 'Composable identity, style, and <b>22 engineering skills</b><br>— including <b>4 native security domains, 4073 lines of original defense</b>.',
  ...
  zh: {
    ...
    'site.desc': '可组合的人格 + 风格 + 22 项工程技能，含 4 个原生安全领域。支持 Claude Code, Codex, Gemini CLI 和 OpenClaw。',
    'nav.how': '原理',
    'nav.security': '安全',
    'nav.personas': '人格',
    'nav.spec': '规范',
    'nav.install': '安装',
    'hero.badge': '4.0 — 原生安全套件 · 无 Apache 依赖',
    'hero.title.1': '给你的 AI 助手',
    'hero.title.2': '一个人格。',
    'hero.sub': '可组合的身份、风格，与 <b>22 项工程技能</b><br>—— 内含 <b>4 个原生安全领域，4073 行原创防御内容</b>。',
    'hero.browse': '浏览人格',
    'hero.submit': '提交你的',
    'hero.runs': '运行于',
    'how.label': '架构',

  ...
  test('所有 runtime guidance 保持在预算内', () => {
    ...
    try {
      ...
      styles.forEach(style => {
        ...
        // Total assembled prompt recommended max 8,000 (docs/specs).
        // Identity layer shrank in persona redesign v3 — headroom restored.
        // Local overlays excluded from this gate.
